...
const sendVerificationOTP = async (email, otp) => {
  ...
  const html = buildEmailTemplate('Verify Your Email Address', 'Your verification code is:', otp);
...
const sendPasswordResetOTP = async (email, otp) => {
  ...
  const html = buildEmailTemplate('Password Reset Code', 'Your password reset code is:', otp);
